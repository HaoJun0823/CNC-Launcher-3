...
namespace CNCLauncher
{
    public static class loc
    {
        ...
        static loc()
        {
            ...
            in_author[i] = "CNC Launcher 3 Author:HaoJun0823 from China Version:" + Config.exeVersion + "\n\n https://github.com/HaoJun0823/CNC-Launcher-3";
            in_error[i] = "Error:";
            ...
            cb_media[i] = "多媒體";
            cb_windowed[i] = "窗口化";
            in_author[i] = "終極動員令系列啓動器 作者：HaoJun0823 來自中國 版本：" + Config.exeVersion + "\n\n https://github.com/HaoJun0823/CNC-Launcher-3";
            in_error[i] = "錯誤：";
            in_execption[i] = "異常：";
